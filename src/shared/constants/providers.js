...
export const APIKEY_PROVIDERS = {
  ...
  "deepseek-web": { id: "deepseek-web", alias: "dsw", name: "DeepSeek Web", icon: "auto_awesome", color: "#4D6BFE", textIcon: "DS", website: "https://chat.deepseek.com", authType: "apikey", authHint: "Paste the Bearer token value from chat.deepseek.com network requests", serviceKinds: ["llm"] },
  ...
  highwayapi: { id: "highwayapi", alias: "hw", name: "Interface AI", icon: "smart_toy", color: "#000000", textIcon: "IF", website: "https://api.highwayapi.ai", notice: { text: "Interface AI — OpenAI-compatible proxy with Claude Fable 5 and other frontier models.", apiKeyUrl: "https://api.highwayapi.ai" }, serviceKinds: ["llm"] },
