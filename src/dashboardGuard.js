...
export async function proxy(request) {
  ...
  // Deny-by-default for /api — allow only explicitly public paths
  if (pathname.startsWith("/api/")) {
    if (isPublicApi(pathname)) return NextResponse.next();

    // Protected API — allow CLI token, JWT, or requireLogin=false
  ...
  if (pathname.startsWith("/dashboard") || pathname.startsWith("/office")) {
